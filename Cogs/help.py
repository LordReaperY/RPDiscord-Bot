...
# ------------------------------------------------------ #  
    ...
    async def help (self, ctx):
        embed = discord.Embed(title=f"__**Help page of {self.bot.user.name}**__", description="[**GitHub**](https://github.com/LordReaperY/Raid-Protect-Discord-Bot)", color=0xdeaa0c)
        ...
        embed.set_footer(text="Bot Created by LordReaper#0001")
